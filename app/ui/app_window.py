...
class AppWindow:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Corrections PDF — Projets")
        ...
        self.ann_tool_var.trace_add("write", lambda *_: (self._update_annot_toolbar_state(), self._update_click_mode()))
    ...
    def _build_pdf_toolbar(self, parent: ttk.Frame) -> None:
        ...
        for txt, val in [("Aucun", "none"), ("Main levée", "ink"), ("Texte", "textbox"), ("Flèche", "arrow"), ("Sélection", "select"), ("Déplacer", "move")]:
            ttk.Radiobutton(
                ...
                text=txt,
                value=val,
                variable=self.ann_tool_var,
                command=lambda: (self._update_annot_toolbar_state(), self._update_click_mode()),
